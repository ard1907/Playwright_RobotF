...
- `docker/tests` bleibt der Docker-Stack fuer CI/CD-Pipeline-Workflows.
- `docker/test-runtime` ist diese lokale bzw. portable Runtime fuer Kollegen.
...
1. Oder fertige Images laden (portable)
