...
- `docker/common/ausweisapp-sdk.Dockerfile` is the single shared build definition for the `ausweisapp-sdk:latest` image used by `docker/sdk`, `docker/tests`, and `docker/test-runtime`.
